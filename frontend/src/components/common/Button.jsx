...
export const Button = ({ children, className, variant = 'primary', size = 'md', isLoading, ...props }) => {
  ...
  const variants = {
    ...
    secondary: "bg-bg-hover text-text-main hover:bg-border focus:ring-border border border-border",
    danger: "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500",
    ghost: "bg-transparent text-text-muted hover:text-text-main hover:bg-bg-hover",
  };
